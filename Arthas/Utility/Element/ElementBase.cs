...
public class ElementBase
{
    ...
    {
        return DependencyProperty.Register(name.Replace("Property", ""), typeof(propertyType), typeof(thisType), new(defaultValue));
    }
    ...
    /// <summary>
    ///     注册事件
    ///     public static readonly RoutedEvent NameRoutedEvent = Utility.RoutedEvent
    ///     <T, T>
    ///         (string,T);
    ...
    {
        return new(name, name, typeof(thisType));
    }
